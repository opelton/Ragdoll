    ...
    public class CubemapTextureBuilder : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("Build Cubemap"))
            {
                ...
                // todo -- rewrite? Creatured texture is placed in the user-selected directory, but then immediately destroyed
                // and the texture is auto-imported to a unity directory the user didn't select, which feels weird?
